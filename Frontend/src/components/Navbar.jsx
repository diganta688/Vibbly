                ...
                <Dialog>
                  <form>
                    <DialogTrigger asChild>
                      <button className="nav-icons-main flex items-center cursor-pointer">
                        <h1 className="text-white text-2xl">
                          <LogOut />
                        </h1>
                        <span
                    ...
                    <DialogContent className="sm:max-w-[425px] bg-base-300">
                      <DialogHeader>
                        <DialogTitle>Sure Want to logout?</DialogTitle>
                        <DialogDescription>
                          If you logout then you need to login with your
                          credientials again
                        </DialogDescription>
                      </DialogHeader>
